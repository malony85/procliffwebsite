...
class Cards extends React.Component {
  ...
  handleScroll(event) {
    if (window.scrollY > 400) {
      document.querySelector(".cardstyle").className = "cardstyle scroll";
      document.querySelector(".cardstyleBold").className = "cardstyleBold scroll";
    } else {
      document.querySelector(".cardstyle").className = "cardstyle";
      document.querySelector(".cardstyleBold").className = "cardstyleBold";
    }
  };
    ...
    <div class='cards_div'>
        <div class='cards_items'>
          ...
          <p class="cardstyle">We offer a full spectrum of IT staffing services to help you meet the needs of your organization with the right people, skills and competencies. 
            ...
            <br/>We strive to fill the vacancy, strategically important positions in your organization with the right people at the right time, without compromising on quality.
The result of which is a productive and agile IT workforce that drives your business forward and helps your organization reach new heights of success.</p>
        ...
        <div class='cards_items1'>
          <p class="devImgP"><img src={devHome} alt="devHome" class="cardsImg"/></p>
